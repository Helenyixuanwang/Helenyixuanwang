...
| [AI Chatbot](https://ai-chatbot-rho-nine-71.vercel.app) | Streaming AI assistant with real-time token delivery, multi-turn conversation history, ElevenLabs text-to-speech narration, autonomous tool use (live weather lookups, safe expression-based calculator with a hand-rolled parser), and terminal dark UI — deployed on Vercel | Next.js, TypeScript, Tailwind CSS, Anthropic Claude API, ElevenLabs API |
