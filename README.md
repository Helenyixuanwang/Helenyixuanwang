...
| [AI Chatbot](https://ai-chatbot-rho-nine-71.vercel.app) | Streaming AI assistant with real-time token delivery, multi-turn conversation history, ElevenLabs text-to-speech narration, and agentic tool use — weather lookups via Open-Meteo API and a custom math expression evaluator — with terminal dark UI, deployed on Vercel | Next.js, TypeScript, Tailwind CSS, Anthropic Claude API, ElevenLabs API |
